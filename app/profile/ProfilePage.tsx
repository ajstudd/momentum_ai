            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="rounded-full bg-red-700 text-white shadow-lg hover:bg-red-800 transition border-2 border-red-400 w-10 h-10 flex items-center justify-center text-sm font-bold"
                        title="Logout"
                    >
                    ...
                    <Link href="/" className="rounded-full bg-indigo-700 text-white shadow-lg hover:bg-indigo-800 transition border-2 border-indigo-400 w-10 h-10 flex items-center justify-center text-sm font-bold" title="Back to Home">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
